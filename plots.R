...
haiti.year <- subset(haiti, year>=lowest_year)$year
haiti.depressive <- subset(haiti, year>=lowest_year)$depressive
haiti.anxiety <- subset(haiti, year>=lowest_year)$anxiety
...
lines(haiti.year, haiti.anxiety, type = "b", col = "red", pch = 17)
...
boxplot(haiti.depressive, names = c("Depressive Disorder"), 
        main = "Depressive Disorder Population Share", ylab = "Share of Population")
## anxiety
boxplot(haiti.anxiety, names = c("Anxiety Disorder"), 
        main = "Anxiety Disorder Population Share", ylab = "Share of Population")
par(mfrow=c(1,1))
